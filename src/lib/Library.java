...
public class Library {
	...
	public static void main (String args[]) {
		...
		//Adding and finding a new book
		CirculatingBook c = new CirculatingBook("Author", "Title", "1232134", "QA.1234");
		System.out.println("Looking for a book not in library returns: " + lib.findBook(c));
		lib.addBook(c);
		lib.sortLibrary(); //Resorting after adding a new book
		System.out.println("Looking for a book after adding it returns:\n" + lib.findBook(c));
